...
\vskip1em
Also, something to take in account and seen with clinicians, they doesn't agree everytime with the groundtruth which create bias with dice which is directly base on the ground truth. In ideal
