...
\title{Title: Development, Robustness Analysis and Clinical Evaluation of a Deep Learning-based Segmentation Model for Head and Neck Cancer Patients}
\author{Léandre Cuenot}
\origin{Switzerland}
\date{\today}
\supervisor{Prof. Dr. Mauricio Reyes}
