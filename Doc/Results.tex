...
In contrast, the perturbation analysis indicates that the nodal channel was significantly more affected by the applied perturbations in the selected cases. Conversely, the distribution of evaluations for the primary channel remains consistent with that of the original cases.
...
Across the two most reliable metrics, the primary label exhibits a stronger correlation, with values approximately 0.66, compared to the nodal channel, which shows a correlation of about 0.53.
